...
(require 'url)
(defun ensure-docs (javadoc-links)
  (if (null javadoc-links)
      'done
    (let* ((javadocs-dir "~/Documents/javadocs/")
           (jar-url (car javadoc-links))
           (jar-title (car (last (split-string jar-url "/" t))))
           (jar-dir-fullpath (concat javadocs-dir (file-name-sans-extension jar-title)))
           (jar-file-fullpath (concat jar-dir-fullpath "/" jar-title)))
      (if (file-exists-p jar-file-fullpath)
          (ensure-docs (cdr javadoc-links))
        (progn
          (make-directory jar-dir-fullpath t)
          (url-copy-file jar-url jar-file-fullpath)
          (shell-command (concat "unzip " jar-file-fullpath " -d " jar-dir-fullpath))
          (ensure-docs (cdr javadoc-links)))))))

(ensure-docs '("https://javadoc.io/jar/org.mybatis/mybatis/3.5.7/mybatis-3.5.7-javadoc.jar"
               "https://javadoc.io/jar/org.springframework/spring-aop/5.3.13/spring-aop-5.3.13-javadoc.jar"
               ;; "https://javadoc.io/jar/org.springframework/spring-core/5.3.13/spring-core-5.3.13-javadoc.jar"
               ;; "https://javadoc.io/jar/org.springframework.boot/spring-boot/2.6.1/spring-boot-2.6.1-javadoc.jar"
               "https://javadoc.io/jar/org.springframework.kafka/spring-kafka/2.8.0/spring-kafka-2.8.0-javadoc.jar"
               ;; "https://download.oracle.com/otn-pub/java/jdk/8u311-b11/4d5417147a92418ea8b615e228bb6935/jdk-8u311-docs-all.zip"
               "https://repo.spring.io/ui/api/v1/download?repoKey=libs-release&path=org/springframework/spring/5.3.9/spring-5.3.9-docs.zip"
               "https://repo.spring.io/ui/api/v1/download?repoKey=libs-release&path=org/springframework/boot/spring-boot-docs/2.6.1/spring-boot-docs-2.6.1.zip"
               "https://repo.spring.io/ui/api/v1/download?repoKey=libs-release&path=org/springframework/boot/spring-boot-actuator-docs/1.5.9.RELEASE/spring-boot-actuator-docs-1.5.9.RELEASE-javadoc.jar"))

(javadoc-add-roots "~/Documents/javadocs/")
